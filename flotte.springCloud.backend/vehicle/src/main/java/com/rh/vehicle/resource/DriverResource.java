...
public class DriverResource {
    ...
    @GetMapping("/projection/drivers")
    @PreAuthorize("hasAuthority('USER')")
    public List<DriverProjectionListMap> getAllDriverProjection(
        ...
        List<DriverProjectionListMap> drs = driverService.findAllProjection(secondPageWithFiveElements,null);
        return drs;
